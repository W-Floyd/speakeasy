...
# ── speakeasy-ss-mdns
FROM variants AS firmware-ss-mdns
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-ss-mdns-6
FROM firmware-ss-mdns AS firmware-ss-mdns-6
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc
FROM firmware-ss-mdns-6 AS firmware-sc
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-6
FROM firmware-sc AS firmware-sc-6
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-mdns
FROM firmware-sc-6 AS firmware-sc-mdns
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-mdns-6
FROM firmware-sc-mdns AS firmware-sc-mdns-6
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-6 AS firmware-ss-mdns-bt
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-ss-mdns-bt AS firmware-ss-mdns-bt-6
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-bt
FROM firmware-ss-mdns-bt-6 AS firmware-sc-bt
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-bt-6
FROM firmware-sc-bt AS firmware-sc-bt-6
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-bt-6 AS firmware-sc-mdns-bt
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-bt AS firmware-sc-mdns-bt-6
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-bt-6 AS firmware-ss-mdns-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-ss-mdns-w9 AS firmware-ss-mdns-6-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-w9
FROM firmware-ss-mdns-6-w9 AS firmware-sc-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-6-w9
FROM firmware-sc-w9 AS firmware-sc-6-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-w9 AS firmware-sc-mdns-6-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-6-w9 AS firmware-ss-mdns-bt-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-ss-mdns-bt-w9 AS firmware-ss-mdns-bt-6-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-bt-w9
FROM firmware-ss-mdns-bt-6-w9 AS firmware-sc-bt-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-bt-w9 AS firmware-sc-bt-6-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-bt-6-w9 AS firmware-sc-mdns-bt-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-bt-w9 AS firmware-sc-mdns-bt-6-w9
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-bt-6-w9 AS firmware-ss-mdns-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-ss-mdns-wr AS firmware-ss-mdns-6-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-wr
FROM firmware-ss-mdns-6-wr AS firmware-sc-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-6-wr
FROM firmware-sc-wr AS firmware-sc-6-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-6-wr AS firmware-sc-mdns-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-wr AS firmware-sc-mdns-6-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-6-wr AS firmware-ss-mdns-bt-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-ss-mdns-bt-wr AS firmware-ss-mdns-bt-6-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-bt-wr
FROM firmware-ss-mdns-bt-6-wr AS firmware-sc-bt-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-bt-wr AS firmware-sc-bt-6-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-bt-6-wr AS firmware-sc-mdns-bt-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-bt-wr AS firmware-sc-mdns-bt-6-wr
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-bt-6-wr AS firmware-ss-mdns-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-ss-mdns-w9r AS firmware-ss-mdns-6-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-w9r
FROM firmware-ss-mdns-6-w9r AS firmware-sc-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-6-w9r
FROM firmware-sc-w9r AS firmware-sc-6-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-6-w9r AS firmware-sc-mdns-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-w9r AS firmware-sc-mdns-6-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-6-w9r AS firmware-ss-mdns-bt-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-ss-mdns-bt-w9r AS firmware-ss-mdns-bt-6-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
# ── speakeasy-sc-bt-w9r
FROM firmware-ss-mdns-bt-6-w9r AS firmware-sc-bt-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-bt-w9r AS firmware-sc-bt-6-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-bt-6-w9r AS firmware-sc-mdns-bt-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
...
FROM firmware-sc-mdns-bt-w9r AS firmware-sc-mdns-bt-6-w9r
RUN --mount=type=cache,target=/root/.ccache,id=ccache \
