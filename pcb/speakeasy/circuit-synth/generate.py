...
import os, re, shutil, pathlib, sys, subprocess
...
def main():
    ...
    from board_helpers import (
        add_lcsc_numbers, preserve_component_uuids, write_jlcpcb_bom,
    )
    ...
    try:
        ...
        _jtext = re.sub(r'"tstamps":\s*"[^"]*"', '"tstamps": "/speakeasy/"', _jtext, count=1)
